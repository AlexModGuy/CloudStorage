...
public class CSItemRegistry {
    ...
    public static final RegistryObject<Item> BALLOON_INVENTORY = DEF_REG.register("balloon_inventory", () -> new InventoryOnlyItem(new Item.Properties()));
    ...
    public static final RegistryObject<Item> BALLOON_BUDDY_INVENTORY = DEF_REG.register("balloon_buddy_inventory", () -> new InventoryOnlyItem(new Item.Properties()));
    ...
    public static final RegistryObject<Item> CLOUD_BLOWER_INVENTORY = DEF_REG.register("cloud_blower_inventory", () -> new InventoryOnlyItem(new Item.Properties()));
    ...
    public static void registerDispenserBehavior(){
        LecternBooks.BOOKS.put(GUIDE_BOOK.getId(), new LecternBooks.BookData(0XDE2727, 0XD6D6D6));
