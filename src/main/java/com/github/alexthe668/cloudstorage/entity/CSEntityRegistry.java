...
public class CSEntityRegistry {
    ...
    public static final RegistryObject<EntityType<BalloonBuddyEntity>> BALLOON_BUDDY = DEF_REG.register("balloon_buddy", () -> EntityType.Builder.of(BalloonBuddyEntity::new, MobCategory.CREATURE).sized(0.7F, 0.9F).build("balloon_buddy"));
    ...
    public static void initializeAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(BALLOON_BUDDY.get(), BalloonBuddyEntity.bakeAttributes().build());
        SpawnPlacements.register(BADLOON.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, BadloonEntity::canBadloonSpawn);
        SpawnPlacements.register(BLOVIATOR.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, BloviatorEntity::canBloviatorSpawn);
    }
