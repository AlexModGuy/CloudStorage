...
public class CSItemRegistry {
    ...
    public static final RegistryObject<Item> MUSIC_DISC_DRIFT = DEF_REG.register("music_disc_drift", () -> new RecordItem(14, CSSoundRegistry.MUSIC_DISC_DRIFT, new Item.Properties().tab(CSCreativeTab.INSTANCE).stacksTo(1).rarity(Rarity.RARE), 146 * 20));
