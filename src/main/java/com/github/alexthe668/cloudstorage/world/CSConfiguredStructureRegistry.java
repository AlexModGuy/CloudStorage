...
public class CSConfiguredStructureRegistry {
    ...
    public static final Holder<ConfiguredStructureFeature<?, ?>> CONFIGURED_SKY_TEMPLE_STRUCTURE = register(CONFIGURED_SKY_TEMPLE, CSStructureRegistry.SKY_TEMPLE.get().configured(NoneFeatureConfiguration.INSTANCE, BiomeTags.HAS_STRONGHOLD));
    public static final Holder<ConfiguredStructureFeature<?, ?>> CONFIGURED_BIG_BALLOON_STRUCTURE = register(CONFIGURED_BIG_BALLOON, CSStructureRegistry.BIG_BALLOON.get().configured(NoneFeatureConfiguration.INSTANCE, BiomeTags.HAS_STRONGHOLD));


    private static TagKey<Biome> create(String str) {
        return TagKey.create(Registry.BIOME_REGISTRY, new ResourceLocation(str));
    }
